...
const Listtermsandcondition = () => {
  ...
  const termsList = () => {
    ...
    axiosConfig
      ...
      .then(function (response) {
        setListData(response.data.TermConditoin);
        setListALLData(response.data.TermConditoin);
        console.log(response.data.TermConditoin);
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  const handleDelete = () => {
    axiosConfig
      .delete(`/term/delete-term-detail/${id}`)
      .then(function (response) {
        termsList();
        setShow(false);
  ...
  const handleEdit = (id) => {
    history.push(`/EditTermsConditions/${id}`);
  };
  return (
    <>
      <div>
        <Modal show={show}>
          ...
          <Modal.Body style={{ padding: "2px 2px 2px 2px" }}>
            <div style={{ textAlign: "center", fontSize: "18px" }}>
              Do you want to delete the Terms & Condition?
            </div>
          </Modal.Body>
          <Modal.Footer>
...
export default Listtermsandcondition;
