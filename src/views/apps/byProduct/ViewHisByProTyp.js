...
class ViewHisByProTyp extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: {},
          ...
          <Row className="m-2">
            <Col>
              <h1 col-sm-6 className="float-left">
                History By Product Type Detail
              </h1>
            </Col>
            <Col>
              <Button
                className=" btn btn-danger float-right"
                onClick={() => history.push("/app/product/historyByProductTyp")}
              >
                Back
              </Button>
            </Col>
...
export default ViewHisByProTyp;
