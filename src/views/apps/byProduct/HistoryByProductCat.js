...
class HistoryByProductCat extends React.Component {
  state = {
    rowData: [],
          ...
          return (
            <div className="actions cursor-pointer">
              <Eye
                ...
                size={20}
                onClick={() =>
                  history.push(`/app/product/viewHisByProTyp/${params.data._id}`)
                }
              />
              <Edit
                className="mr-50"
              ...
              <Row className="m-2">
                <Col>
                  <h1 sm="6" className="float-left">
                    History By Product Category List
                  </h1>
                </Col>
                <Col>
                  <Button
                    className=" btn btn-danger float-right"
                    onClick={() => history.push("/app/product/addHisByProCat")}
                  >
                    Add History By Product Category
                  </Button>
                </Col>
              </Row>
              <CardBody>
...
export default HistoryByProductCat;
