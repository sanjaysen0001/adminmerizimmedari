          ...
          return (
            <div className="actions cursor-pointer">
              <Eye
                ...
                size={20}
                onClick={() =>
                  history.push(`/app/store/storesRequest/viewStoresRequest/${params.data._id}`)
                }
              />
              <Edit
                className="mr-50"
                size={20}
                onClick={() => history.push("/app/store/storesRequest/editStoresRequest")}
              />
              <Trash2
                size={20}
                onClick={() => {
              ...
              <Row className="m-2">
                ...
                {/* <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/store/storesRequest/addStoresRequest")}
                  >
                    Add Stores Request
                  </Button>
                </Col> */}
