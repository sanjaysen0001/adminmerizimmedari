...
class AdvertiesementList extends React.Component {
  state = {
    rowData: [],
          ...
          return (
            <div className="actions cursor-pointer">
              <Eye
                ...
                size={20}
                onClick={() =>
                  history.push(`/app/marketing/advertiesement/viewAdvertiesement/${params.data._id}`)
                }
              />
              <Edit
                className="mr-50"
                size={20}
                onClick={() => history.push("/app/marketing/advertiesement/editAdvertiesement")}
              />
              <Trash2
                size={20}
                onClick={() => {
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/marketing/advertiesement/addAdvertiesement")}
                  >
                    Add Advertiesement 
                  </Button>
                </Col>
...
export default AdvertiesementList;