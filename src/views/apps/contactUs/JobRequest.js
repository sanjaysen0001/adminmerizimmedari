...
class JobRequest extends React.Component {
  state = {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <div className="ml-2">
                <span>{params.data.email_address}</span>
              </div>
            </div>
          );
        },
      ...
      {
        headerName: "Field Choice",
        field: "enterfield_choice",
        filter: true,
        resizable: true,
        width: 180,
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <div className="ml-2">
                <span>{params.data.enterfield_choice}</span>
              </div>
            </div>
          );
        },
  ...
  async componentDidMount() {
    await axiosConfig.get("/allcareerform").then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/delcareerform/${id}`).then((response) => {
