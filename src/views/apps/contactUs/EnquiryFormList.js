...
class EnquiryFormList extends React.Component {
  state = {
    rowData: [],
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <div className="ml-2">
                <span>{params.data.customer_type}</span>
              </div>
            </div>
          );
        },
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <div className="ml-2">
                <span>{params.data.service_type}</span>
              </div>
            </div>
          );
        },
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <div className="ml-2">
                <span>{params.data.alt_mobileno}</span>
              </div>
            </div>
          );
        },
  ...
  async componentDidMount() {
    await axiosConfig.get("/allservicerequest").then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/delservicerequest/${id}`).then((response) => {
