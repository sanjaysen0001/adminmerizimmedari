...
class ViewSalesReturnHis extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: {},
        ...
        <Card className="overflow-hidden app-ecommerce-details">
          <Row className="m-2">
            <Col>
              ...
              Sales Return History Detail
              </h1>
            </Col>
            <Col>
              <Button
                className=" btn btn-danger float-right"
                onClick={() => history.push("/app/sales/salesByItem")}
              >
                Back
              </Button>
            </Col>
...
export default ViewSalesReturnHis;
