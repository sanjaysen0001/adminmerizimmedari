...
class InvoicedIncome extends React.Component {
  state = {
    rowData: [],
          ...
          return (
            <div className="actions cursor-pointer">
              <Eye
                ...
                size={20}
                onClick={() =>
                  history.push(`/app/salses/viewInvoicedIncome/${params.data._id}`)
                }
              />
              <Edit
                className="mr-50"
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/sales/addInvoicedIncome")}
                  >
                  Add Invoiced Income
                  </Button>
                </Col>
